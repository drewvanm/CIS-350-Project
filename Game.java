...
public class Game {
	 ...
	 * 
	 * @param numOfPlayers how many players are in the game
	 */
	...
	/**
	 * This method is used to set who is next 
	 * to choose the actor for top of round.
	 * The player who is next to choose is the first person to lose the round
	 * @param nextChooser A Player who becomes the next to choose
	 */
	 ...
	 * @param indexOfPlayer the player index.
	 * @param name the player name.
	 */
	public final void setPlayerName(
			final int indexOfPlayer, final String name) {
			players.get(indexOfPlayer).setName(name);
	...
	/**
	 * Get any player.
	 * @param indexOfPlayer player index.
