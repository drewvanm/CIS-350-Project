/**
 * 
 * @author Trevor This class holds each player.
 */
public class Player {
	/**
	 * Player's score.
	...
	/**
	 * Constructor: initialize player with score of zero, active flag set true
	 * and passed name.
	 * 
	 * @param pName
	...
	/**
	 * Method to remove player from current round after failing to answer
	 * correctly (set active flag false).
	 */
